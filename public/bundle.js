...
/******/ 	var hotCurrentHash = "02d4bb4d05ff7f3d6c44"; // eslint-disable-line no-unused-vars
...
var App = exports.App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return createVNode(2, 'div', null, [createVNode(2, 'header', null, createVNode(2, 'h1', null, 'API Documentation')), createVNode(2, 'div', 'content-container', createVNode(16, _Explorer2.default, null, null, _extends({}, this.props))), createVNode(2, 'footer', null, [createVNode(2, 'a', null, 'Swagger UI Light 1.0.0', {
        'href': 'https://github.com/AirshipCMS/Swagger-UI-Light',
        'target': '_blank'
      }), createVNode(2, 'a', null, 'MIT License', {
        'href': 'https://github.com/AirshipCMS/Swagger-UI-Light/blob/master/LICENSE',
        'target': '_blank'
      })])]);
    }
  }]);
...
var ExploreByTags = function (_Component) {
  ...
  _createClass(ExploreByTags, [{
    ...
    value: function formatDescription(description) {
...
function PathDetail(_ref) {
  ...
  return createVNode(2, 'div', className, [path.definition.description ? createVNode(2, 'div', 'implementation-notes', [createVNode(2, 'p', null, 'Implementation Notes'), createVNode(2, 'p', null, path.definition.description)]) : null, consumes ? createVNode(2, 'div', null, [createVNode(2, 'p', null, 'Consumes'), createVNode(2, 'p', null, consumes.join(" | "))]) : null, produces ? createVNode(2, 'div', null, [createVNode(2, 'p', null, 'Produces'), createVNode(2, 'p', null, produces.join(" | "))]) : null, parameters ? createVNode(2, 'div', null, [createVNode(2, 'p', null, 'Parameters'), parameters.map(function (param) {
    ...
    })) : null, param.default !== undefined ? createVNode(2, 'p', null, 'Default Value:') : null, param.default !== undefined ? createVNode(2, 'div', 'schema', createVNode(2, 'pre', 'language-javascript', createVNode(2, 'code', 'language-javascript', param.default))) : null]);
  })]) : null]);
}
